...
* container(부모속성), item(자식속성)에 주는 속성이 다르기 때문에 주의해서 작성해야 합니다! **기본 시작은 부모** (자식은 필요할 때만 부분적으로 사용)
...
* transition속성은 hover 등 동작을 따라가는게 아닌 변화하는 CSS 값이 어떤 요소에 들어가느냐를 기준으로 적용된다.
### 가속도 종류
